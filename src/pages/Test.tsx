...
export default function Test({ mode, onComplete, onCancel }: { mode: 'normal' | 'deep', onComplete: (id: string) => void, onCancel: () => void }) {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col font-sans transition-colors duration-300 relative">
      ...
      {/* Background Orbs */}
      <div className="absolute top-[20%] right-[-10%] w-[50vw] h-[50vw] rounded-full bg-blue-500/10 dark:bg-blue-600/10 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-20%] w-[60vw] h-[60vw] rounded-full bg-indigo-500/10 dark:bg-indigo-600/10 blur-[100px] pointer-events-none" />
